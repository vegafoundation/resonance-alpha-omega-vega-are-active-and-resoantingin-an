...
\title{ALPHA OMEGA VEGA ARE ACTIVE AND RESOANTINGIN AN: Un marco conceptual}
...
\begin{abstract}
Este trabajo introduce ALPHA OMEGA VEGA ARE ACTIVE AND RESOANTINGIN AN como un nuevo marco conceptual dentro del paradigma de Resonance Data y QIRC.
